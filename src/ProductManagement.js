  ...
  return (
    <div className="row">
      <div className="col-lg-4">
        <form style={formStyles}>
          <h4 style={{textAlign:'center'}}>Product Management</h4>
    ...
    <table className="table table-responsive">
      <thead className="text-center">
        <tr>
          <th scope="col" className="bg-secondary text-white">Product ID</th>
          <th scope="col" className="bg-secondary text-white">Name</th>
          <th scope="col" className="bg-secondary text-white">Price</th>
          <th scope="col" className="bg-secondary text-white">Stock</th>
          <th scope="col" className="bg-secondary text-white">Category</th>
          <th scope="col" className="bg-secondary text-white">Action</th>
        </tr>
      </thead>
